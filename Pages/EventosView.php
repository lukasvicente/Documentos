...
<div class="col s12 m4 l3">
        ...
        function mountNoticia($values)
        {
          ...
          if( $i >= $valor_pag_begin  and $i <=  $valor_pag_end ){
                ...
                $div = '
                <div class="section">
  	<img id="img-noticia-list" src="' . UtilWebservice::$HOST_NAME . UtilWebservice::$PROJECT_NAME . '/app/images/site/' . $value['nomearquivo'] . '">
    <h5>' . $value['titulo'] . '</h5>
    
  </div><a class="grey-text"> <i class="material-icons tiny">watch_later</i> Há 4 Horas</a>
  <br><br><br><br>
